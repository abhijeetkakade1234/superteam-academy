...
import { Trophy, Medal, Star, Shield, Zap, Lock, ExternalLink, Share2, Award, Code, Globe } from "lucide-react";
...
const ACHIEVEMENTS: Achievement[] = [
  ...
  {
    id: "course-completer",
    title: "achievements.courseCompleter.title",
    description: "achievements.courseCompleter.desc",
    icon: Award,
    rarity: "common",
    category: "progress",
    progress: 0,
  ...
  {
    id: "speed-runner",
    title: "achievements.speedRunner.title",
    description: "achievements.speedRunner.desc",
    icon: Zap,
    rarity: "rare",
    category: "progress",
    progress: 0,
  ...
  {
    id: "monthly-master",
    title: "achievements.monthlyMaster.title",
    description: "achievements.monthlyMaster.desc",
    icon: Trophy,
    rarity: "epic",
    category: "streaks",
    progress: 20,
  ...
  {
    id: "consistency-king",
    title: "achievements.consistencyKing.title",
    description: "achievements.consistencyKing.desc",
    icon: Trophy,
    rarity: "legendary",
    category: "streaks",
    progress: 5,
  ...
  {
    id: "rust-rookie",
    title: "achievements.rustRookie.title",
    description: "achievements.rustRookie.desc",
    icon: Code,
    rarity: "common",
    category: "skills",
    progress: 40,
  ...
  {
    id: "anchor-expert",
    title: "achievements.anchorExpert.title",
    description: "achievements.anchorExpert.desc",
    icon: Shield,
    rarity: "rare",
    category: "skills",
    isSoulbound: true,
  ...
  {
    id: "fullstack-solana",
    title: "achievements.fullStackSolana.title",
    description: "achievements.fullStackSolana.desc",
    icon: Globe,
    rarity: "epic",
    category: "skills",
    progress: 0,
  ...
  {
    id: "helper",
    title: "achievements.helper.title",
    description: "achievements.helper.desc",
    icon: Medal,
    rarity: "common",
    category: "community",
    progress: 0,
  ...
  {
    id: "first-comment",
    title: "achievements.firstComment.title",
    description: "achievements.firstComment.desc",
    icon: Medal,
    rarity: "common",
    category: "community",
    progress: 0,
  ...
  {
    id: "top-contributor",
    title: "achievements.topContributor.title",
    description: "achievements.topContributor.desc",
    icon: Trophy,
    rarity: "rare",
    category: "community",
    progress: 0,
  ...
  {
    id: "early-adopter",
    title: "achievements.earlyAdopter.title",
    description: "achievements.earlyAdopter.desc",
    icon: Award,
    rarity: "epic",
    category: "special",
  ...
  {
    id: "bug-hunter",
    title: "achievements.bugHunter.title",
    description: "achievements.bugHunter.desc",
    icon: Shield,
    rarity: "legendary",
    category: "special",
    progress: 0,
  },
  {
    ...
    description: "achievements.perfectScore.desc",
    icon: Star,
    rarity: "rare",
    category: "special",
    progress: 0,
              ...
              {CATEGORIES.map((cat, catIdx) => (
                <div key={cat.id} className="space-y-8">
                  <div className="flex items-center gap-4">
                    <h2 className="text-2xl font-bold tracking-tight text-white/90">{cat.label}</h2>
                    <div className="h-px flex-1 bg-white/10" />
                    <span className="text-xs font-medium text-white/20 uppercase tracking-widest">
                      {ACHIEVEMENTS.filter(a => a.category === cat.id).length} badges
                    </span>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {ACHIEVEMENTS.filter(a => a.category === cat.id).map((achievement, idx) => {
